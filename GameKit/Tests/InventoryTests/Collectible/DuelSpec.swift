                    ...
                    expect(result) == [
                        ...
                        .chooseOne(player: "p2", options: [
                            "bang-2": .group([
                                ...
                                .effect(.challenge(.id("p2"), effect: .discard(.selectHandNamed(.bang)), otherwise: .damage(1)), ctx: EffectContext(actor: "p1", card: .duel, target: "p1"))
                            ]),
                    ...
                    expect(result) == [
                        ...
                        .chooseOne(player: "p1", options: [
                            "bang-1": .group([
                                ...
                                // swiftlint:disable:next line_length
                                .effect(.challenge(.id("p1"), effect: .discard(.selectHandNamed(.bang)), otherwise: .damage(1)), ctx: EffectContext(actor: "p1", card: .duel, target: "p2"))
                            ]),
