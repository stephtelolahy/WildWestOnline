...
public extension String {
    ...
    static let discardExcessHandOnEndTurn = "discardExcessHandOnEndTurn"
    static let drawOnStartTurn = "drawOnStartTurn"
    ...
    static let playCounterCardsOnShot = "playCounterCardsOnShot"
